...
export default function Home() {
    ...
    useEffect(() => {
        const scrollListener = () => {
            if (title.current) {
                title.current.style.marginTop = `${window.scrollY}px`;
            }
        };
    ...
    return (
        <>
            <section className="font-inter relative flex h-svh min-h-142.5 flex-col items-center justify-center overflow-hidden">
                ...
                <p
                    ref={description}
                    className="font-inria-sans mt-10 w-[80%] max-w-2xs text-center text-lg opacity-90 sm:text-xl md:text-2xl lg:text-3xl"
                >
